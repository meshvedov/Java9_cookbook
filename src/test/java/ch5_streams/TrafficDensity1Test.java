...
public class TrafficDensity1Test {
    ...
    public void testTrafficByLane() {
        ...
        double[] speedLimitByLane = {30.0, 50.0, 65.0};
    ...
    private TrafficUnit getTrafficUnit(int i) {
        return new TrafficUnit() {
            ...
            public Vehicle.VehicleType getVehicleType() {
                return (i & 3) == 1 ? Vehicle.VehicleType.CAR : (i & 3) == 2 ? Vehicle.VehicleType.TRUCK : Vehicle.VehicleType.CAB_CREW;
            }
            ...
            public double getTraction() {
                return (i & 3) == 1 ? 0.2 : (i & 3) == 2 ? 0.1 : 0.4;
            }
